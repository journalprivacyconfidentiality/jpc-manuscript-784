...
\jpcheading{0}{0}{2022}{}{Apr.~15, 2021}{Jun.~15, 2022}{}{Special issue}
...
\author[C.~Canonne]{Cl\'ement L. Canonne}	\address{School of Computer Science, University of Sydney}	\email{clement.canonne@sydney.edu.au}  
\thanks{This work was completed while CC and TS were at IBM Research -- Almaden (CC as a Goldstine Postdoctoral Fellow). %
GK is supported by an NSERC Discovery grant, a Compute Canada RRG grant, and a University of Waterloo startup grant. %
}	

\author[G.~Kamath]{Gautam Kamath}	\address{Cheriton School of Computer Science, University of Waterloo}	\email{g@csail.mit.edu}  
%\thanks{GK is supported by an NSERC Discovery grant, a Compute Canada RRG grant, and a University of Waterloo startup grant.}	
